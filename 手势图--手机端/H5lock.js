...
H5lock.prototype.storePass = function (psw) {// touchend结束之后对密码和状态的处理
    if (this.pswObj.step === 1) {
        if (this.checkPass(this.pswObj.fpassword, psw)) {
            ...
            window.localStorage.setItem('passwordxx', JSON.stringify(this.pswObj.spassword));   //将密码保存
...
H5lock.prototype.initDom = function () {
    ...
    const str = `<h4 id="title" class="title">绘制解锁图案</h4>
            <a id="updatePassword" style="position: absolute;right: 5px;top: 5px;font-size: 10px;display:none;">重置密码</a>
...
//JavaScript原生选择器比如querySelector比jquery更高效, 因为前者直接调用了js引擎